...
<body>
   ...
   <div id="mallPage" class="tms-page mallAct tmall-login w1190 page-market">
      ...
      <div class="content">
            ...
            <div id="login-banner-wrap" style="width: 100%; background-color: rgb(51, 139, 255); " title="天猫七夕节">
            	<div class="inner">
            		<img src="images/register-1190-600.png" alt="">
  ...
  <iframe id="J_loginIframe" src="registerkuang.jsp" scrolling="no" border="0"width="320" frameborder="no">
